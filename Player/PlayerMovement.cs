...
namespace Player
{
    public class PlayerMovement : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            {
                playerController.Move((_currentSpeed * Time.deltaTime * _move));
            }
        ...
        private void LedgeGrab()
        {
            ...
            //Creates the raycast
            var playerTransform = transform;
            var ray = Physics.Raycast(playerTransform.position + rayOffset + playerTransform.forward * rayDistance, Vector3.down, rayLength, groundMask);
